  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div
          className="relative transform overflow-hidden rounded-xl bg-white/90 backdrop-blur-md shadow-2xl transition-all sm:w-full sm:max-w-lg border border-gray-200"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100/90 sm:mx-0 sm:h-10 sm:w-10">
                <svg
          ...
          <div className="bg-gray-50/90 backdrop-blur-sm px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              type="button"
              onClick={onConfirm}
